...
//
{
  ...
  {
    cout << "\n";
    cout << "KEAST_SUBORDER - Fatal error!\n";
    cout << "  Illegal RULE = " << rule << "\n";
    exit ( 1 );
  }
...
//
{
  ...
  else
  {
    suborder_num = -1;
    cout << "\n";
    cout << "KEAST_SUBORDER_NUM - Fatal error!\n";
    cout << "  Illegal RULE = " << rule << "\n";
    exit ( 1 );
  }
...
//
{
  ...
  {
    cout << "\n";
    cout << "KEAST_SUBRULE - Fatal error!\n";
    cout << "  Illegal RULE = " << rule << "\n";
    exit ( 1 );
  }
//
