...
//  Purpose:
//
//    MAIN is the main program for NCO_TRIANGLE_PRB.
//
//  Discussion:
//
//    NCO_TRIANGLE_PRB calls the NCO_TRIANGLE test routines.
//
//  Modified:
//
//    30 January 2007
...
//
{
  ...
  cout << "\n";
  cout << "NCO_TRIANGLE_PRB:\n";
  cout << "  C++ version\n";
  cout << "  Test the NCO_TRIANGLE library.\n";
...
//
{
  ...
  cout << "\n";
  cout << "TEST01\n";
  cout << "  NCO_TRIANGLE_RULE_NUM returns the number of rules;\n";
  cout << "  NCO_TRIANGLE_DEGREE returns the degree of a rule;\n";
  cout << "  NCO_TRIANGLE_ORDER_NUM returns the order of a rule.\n";

  rule_num = nco_triangle_rule_num ( );
...
//
{
  ...
  cout << "\n";
  cout << "TEST02\n";
  cout << "  NCO_TRIANGLE_RULE returns the points and weights\n";
  ...
  for ( rule = 1; rule <= rule_num; rule++ )
  {
    ...
    nco_triangle_rule ( rule, order_num, xytab, wtab );
...
//
{
  ...
  cout << "\n";
  cout << "TEST04\n";
  cout << "  NCO_TRIANGLE_RULE returns the points and weights of\n";
...
# define NODE_NUM 3
  ...
  cout << "  set of NCO points.\n";
  cout << "\n";

  strcpy ( file_name, "nco_triangle_rule_00.eps" );
...
# define NODE_NUM 3
  ...
  nco_triangle_rule ( rule, order_num, xy, w );
//
