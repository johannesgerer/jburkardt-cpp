...
double monomial_quadrature_gen_hermite ( int expon, double alpha, int order, 
...
//
{
  ...
  timestamp ( );
  cout << "\n";
  cout << "INT_EXACTNESS_GEN_HERMITE\n";
  cout << "  C++ version\n";
  cout << "\n";
  cout << "  Compiled on " << __DATE__ << " at " << __TIME__ << ".\n";
  cout << "\n";
  cout << "  Investigate the polynomial exactness of a generalized Gauss-Hermite\n";
...
//
  ...
  cout << "\n";
  cout << "  The requested power of |X| is = " << alpha << "\n";
//
...
//
  ...
  else
  {
    ...
    cout << "0: standard rule for integrating |x|^alpha*exp(-x*x)*f(x)\n";
...
//
  cout << "\n";
  cout << "INT_EXACTNESS_GEN_HERMITE: User input:\n";
  ...
  cout << "  Power of |X|, ALPHA = " << alpha << "\n";
  if ( option == 0 )
  {
    cout << "  OPTION = 0, integrate |x|^alpha*exp(-x*x)*f(x)\n";
  }
  else
  {
...
//
  ...
  {
    cout << "\n";
    cout << "INT_EXACTNESS_GEN_HERMITE - Fatal error!\n";
...
//
  ...
  cout << "  a generalized Gauss-Hermite rule\n";
  cout << "  ORDER = " << order << "\n";
  cout << "  ALPHA = " << alpha << "\n";
  cout << "\n";
  if ( option == 0 )
  {
    ...
    cout << "    Integral ( -oo < x < +oo ) |x|^alpha exp(-x*x) f(x) dx\n";
...
//
  cout << "\n";
  cout << "  A generalized Gauss-Hermite rule would be able to exactly\n";
...
//
  ...
  else
  {
    for ( i = 0; i < order; i++ )
    {
      quad = quad + w[i] * pow ( r8_abs ( x[i] ), alpha )
      * exp ( - x[i] * x[i] ) * pow ( x[i], expon );
    }
  }
//
//  Error:
