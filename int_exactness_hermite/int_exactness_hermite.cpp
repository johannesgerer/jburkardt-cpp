...
double monomial_quadrature_hermite ( int expon, int order, int option,
  double w[], double x[] );
...
//
  ...
  {
    cerr << "\n";
    cerr << "INT_EXACTNESS_HERMITE - Fatal error!\n";
...
//
  cout << "\n";
  cout << "INT_EXACTNESS_HERMITE: User input:\n";
...
//
//    Output, double MONOMIAL_QUADRATURE_HERMITE, the quadrature error.
//
{
  double exact;
  int i;
