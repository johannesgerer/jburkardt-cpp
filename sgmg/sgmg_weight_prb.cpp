...
void sgmg_weight_test ( int dim_num, int level_max_min, 
...
//  Purpose:
//
//    MAIN is the main program for SGMG_WEIGHT_PRB.
//
//  Discussion:
//
...
//
{
  ...
  gw_compute_points = new GWPointer[dim_num];
  gw_compute_points[0] = webbur::clenshaw_curtis_compute_points_np;
  gw_compute_points[1] = webbur::fejer2_compute_points_np;
  gw_compute_weights = new GWPointer[dim_num];
  gw_compute_weights[0] = webbur::clenshaw_curtis_compute_weights_np;
  gw_compute_weights[1] = webbur::fejer2_compute_weights_np;
  sgmg_weight_test ( dim_num, level_max_min, level_max_max, 
    rule, growth, np, p, gw_compute_points, gw_compute_weights, tol );
  delete [] growth;
  delete [] gw_compute_points;
