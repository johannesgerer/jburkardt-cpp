...
void sgmg_index_test ( int dim_num, int level_max_min, 
...
//  Purpose:
//
//    MAIN is the main program for SGMG_INDEX_PRB.
//
//  Discussion:
//
...
//
{
  ...
  for ( dim = 0; dim < dim_num; dim++ )
  {
    ...
    {
      std::cerr << "\n";
      std::cerr << "SGMG_INDEX_TEST - Fatal error!\n";
  ...
  for ( level_max = level_max_min; level_max <= level_max_max; level_max++ )
  {
    ...
    webbur::sgmg_index ( dim_num, level_max, rule, 
