...
double monomial_quadrature_gen_laguerre ( int expon, double alpha, int order, 
...
//
{
  ...
  timestamp ( );
  cout << "\n";
  cout << "INT_EXACTNESS_GEN_LAGUERRE\n";
  cout << "  C++ version\n";
  cout << "\n";
  cout << "  Compiled on " << __DATE__ << " at " << __TIME__ << ".\n";
  cout << "\n";
  cout << "  Investigate the polynomial exactness of a generalized Gauss-Laguerre\n";
...
//
  ...
  {
    cout << "\n";
    cout << "  ALPHA is the power of X in the weighting function.\n";
    cout << "\n";
...
//
  ...
  else
  {
    ...
    cout << "0: standard rule for integrating x^allpha*exp(-x)*f(x)\n";
...
//
  cout << "\n";
  cout << "INT_EXACTNESS_GEN_LAGUERRE: User input:\n";
  ...
  cout << "  Weighting exponent ALPHA = " << alpha << "\n";
  if ( option == 0 )
  {
    cout << "  OPTION = 0, integrate x^alpha*exp(-x)*f(x)\n";
  }
  else
  {
...
//
  ...
  {
    cout << "\n";
    cout << "INT_EXACTNESS_GEN_LAGUERRE - Fatal error!\n";
...
//
  ...
  {
    cout << "\n";
    cout << "INT_EXACTNESS_GEN_LAGUERDRE - Fatal error!\n";
...
//
  ...
  cout << "  a generalized Gauss-Laguerre rule\n";
  cout << "  ORDER = " << order << "\n";
  cout << "  with A =     " << a << "\n";
  cout << "  and  ALPHA = " << alpha << "\n";
  cout << "\n";
  if ( option == 0 )
  {
    cout << "  Standard rule:\n";
    cout << "    Integral ( A <= x < +oo ) x^alpha exp(-x) f(x) dx\n";
...
//
  cout << "\n";
  cout << "  A generalized Gauss-Laguerre rule would be able to exactly\n";
  ...
  {
    quad_error = monomial_quadrature_gen_laguerre ( degree, alpha, order, 
    option, w, x );
...
//
  ...
  else
  {
    for ( i = 0; i < order; i++ )
    {
      quad = quad + w[i] * pow ( x[i], alpha ) * exp ( - x[i] ) * pow ( x[i], expon );
    }
  }
//
//  Error:
