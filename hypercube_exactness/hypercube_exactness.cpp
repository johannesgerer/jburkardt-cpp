...
//
{
  ...
  timestamp ( );
  cout << "\n";
  cout << "HYPERCUBE_EXACTNESS\n";
  cout << "  C++ version\n";
  cout << "\n";
  cout << "  Investigate the polynomial exactness of a quadrature\n";
  cout << "  rule by integrating all monomials of a given degree\n";
  cout << "  over the [0,1] hypercube.\n";
  cout << "\n";
  cout << "  The rule will be adjusted to the [0,1] hypercube.\n";
//
...
//
  cout << "\n";
  cout << "HYPERCUBE_EXACTNESS: User input:\n";
...
//
  ...
  {
    cerr << "\n";
    cerr << "HYPERCUBE_EXACTNESS - Fatal error!\n";
