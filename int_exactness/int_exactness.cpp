...
//
{
  ...
  cout << "\n";
  cout << "  Investigate the polynomial exactness of a\n";
  cout << "  quadrature rule by integrating all\n";
  cout << "  monomials up to a given degree over the [0,+1] interval.\n";
  cout << "\n";
  cout << "  If necessary, the rule is adjusted to the [0,1] interval.\n";
//
...
//
  cout << "\n";
  cout << "  The quadrature rule to be tested:\n";
  cout << "  ORDER = " << order << "\n";
  cout << "\n";
  cout << "  Standard rule:\n";
  cout << "    Integral ( R[0] <= x <= R[1] ) f(x) dx\n";
...
//
  ...
  {
    quad_error = monomial_quadrature ( degree, order, w, x );
