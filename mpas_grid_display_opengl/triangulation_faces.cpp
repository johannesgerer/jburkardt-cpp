...
//
//  Get the cell-to-vertex connectivity in cellsOnVertex.
//
...
//
  ...
  {
    cout << "\n";
    cout << "TRIANGULATION_FACES: - Fatal error!\n";
...
//
  for ( v = 0; v < nvertices; v++ )
  {
    for ( i = 0; i < 3; i++ )
    {
      cellsonvertex[i+v*3] = cellsonvertex[i+v*3] - 1;
    }
  }
//
