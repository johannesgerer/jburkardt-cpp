...
//
{
  timestamp ( );
  cout << "\n";
  cout << "SPHERE_LLQ_GRID_TEST\n";
  cout << "  C++ version\n";
  cout << "  Test the SPHERE_LLQ_GRID library.\n";
...
//
{
  ...
  cout << "\n";
  cout << "SPHERE_LLQ_GRID_POINT_COUNT_TEST\n";
  cout << "  SPHERE_LLQ_GRID_POINT_COUNT counts the points used for a\n";
  cout << "  grid based on quadrilaterals defined by latitude and longitude\n";
...
//
{
  ...
  cout << "\n";
  cout << "SPHERE_LLQ_GRID_POINTS_TEST\n";
  cout << "  SPHERE_LLQ_POINTS produces latitude/longitude\n";
...
//
{
  ...
  cout << "\n";
  cout << "SPHERE_LLQ_GRID_LINE_COUNT_TEST\n";
  cout << "  SPHERE_LLQ_GRID_LINE_COUNT counts the lines used for a\n";
  cout << "  grid based on quadrilaterals defined by latitude and longitude\n";
  cout << "  lines on a sphere in 3D.\n";
  cout << "\n";
...
//
{
  ...
  cout << "\n";
  cout << "SPHERE_LLQ_GRID_LINES_TEST\n";
  cout << "  SPHERE_LLQ_GRID_LINES computes grid lines\n";
...
//
{
  ...
  cout << "\n";
  cout << "SPHERE_LLQ_GRID_DISPLAY_TEST\n";
  cout << "  SPHERE_LLQ_GRID_DISPLAY displays an LLQ grid on a sphere.\n";
  cout << "\n";
  cout << "  Number of latitudes is  " << lat_num << "\n";
  cout << "  Number of longitudes is " << long_num << "\n";
//
