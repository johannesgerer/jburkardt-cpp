...
//
{
  if ( s_len_trim ( node_coord_file_name ) <= 0 )
  {
    cout << "\n";
    cout << "FEM_DATA_READ:\n";
    cout << "  No node coordinate file name was supplied!\n";
    cout << "  NO DATA WILL BE READ!\n";
    return;
  }
...
//
{
  ...
  cout << "  Number of node data items = " << node_data_num << "\n";
...
//
{
  ...
  {
    cout << "\n";
    cout << "FEM_HEADER_READ:\n";
    cout << "  No element file name was supplied.\n";
    cout << "  Therefore, no element data will be returned.\n";
  }
  ...
  if ( s_len_trim ( node_data_file_name ) <= 0 )
  {
    cout << "\n";
    cout << "FEM_HEADER_READ:\n";
    cout << "  No node data file name was supplied!\n";
    cout << "  Therefore, no node data will be returned.\n";
  }
//
...
//
  ...
  if ( 0 < s_len_trim ( node_data_file_name ) )
  {
    ...
    {
      cout << "\n";
      cout << "  The number of nodes in the node coordinate\n";
      cout << "  file is " << *node_num << " but the number of nodes\n";
      cout << "  in the node data file is " << node_num2 << "\n";
      cout << "  Because of this, no node data will be stored.\n";
      *node_data_num = 0;
    }
  }
  else
...
//
{
  ofstream element_file_unit;
  ofstream node_coord_file_unit;
  ofstream node_data_file_unit;
//
...
//
  if ( 0 < s_len_trim ( node_coord_file_name ) )
  {
    ...
    cout << "\n";
    cout << "FEM_WRITE wrote node coordinates to \""
...
//
  if ( 0 < s_len_trim ( node_data_file_name ) )
  {
    ...
    cout << "\n";
    cout << "FEM_WRITE wrote node data to \""
         << node_data_file_name << "\".\n";
  }
