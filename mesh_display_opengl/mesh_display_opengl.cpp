...
//  Purpose:
//
//    MAIN is the main program for MESH_DISPLAY_OPENGL.
//
//  Discussion:
//
...
//
  ...
  {
    cout << "\n";
    cout << "MESH_DISPLAY_OPENGL - Fatal error!\n";
...
//
  ...
  if ( element_num < 1 )
  {
    cout << "\n";
    cout << "MESH_DISPLAY_OPENGL - Fatal error!\n";
    cout << "  The number of elements must be at least 1!\n";
    exit ( 1 );
  }
