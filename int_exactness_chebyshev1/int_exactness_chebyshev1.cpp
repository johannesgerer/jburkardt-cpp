...
//
{
  ...
  timestamp ( );
  cout << "\n";
  cout << "INT_EXACTNESS_CHEBYSHEV1\n";
  cout << "  C++ version\n";
  cout << "\n";
  cout << "  Compiled on " << __DATE__ << " at " << __TIME__ << ".\n";
  cout << "\n";
  cout << "  Investigate the polynomial exactness of a Gauss-Chebyshev\n";
  cout << "  type 1 quadrature rule by integrating weighted\n";
...
//
  cout << "\n";
  cout << "INT_EXACTNESS_CHEBYSHEV1: User input:\n";
...
//
  ...
  {
    cout << "\n";
    cout << "INT_EXACTNESS_CHEBYSHEV1 - Fatal error!\n";
...
//
  cout << "\n";
  cout << "  A Gauss-Chebyshev type 1 rule would be able to exactly\n";
...
double monomial_quadrature_chebyshev1 ( int expon, int order, double w[], 
  double x[] )
