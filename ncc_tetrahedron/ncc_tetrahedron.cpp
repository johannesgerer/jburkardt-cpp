...
//  Purpose:
//
//    NCC_TETRAHEDRON_DEGREE: degree of an NCC rule for the tetrahedron.
//
//  Licensing:
//
...
//
//    Output, int NCC_TETRAHEDRON_DEGREE, the polynomial degree of exactness of
//    the rule.
//
{
  int degree;
  ...
  else
  {
    degree = -1;
    cout << "\n";
    cout << "NCC_TETRAHEDRON_DEGREE - Fatal error!\n";
...
//  Purpose:
//
//    NCC_TETRAHEDRON_ORDER_NUM: order of an NCC rule for the tetrahedron.
//
//  Licensing:
//
//    This code is distributed under the GNU LGPL license. 
...
//    Input, int RULE, the index of the rule.
//
//    Output, int NCC_TETRAHEDRON_ORDER_NUM, the order (number of points) 
//    of the rule.
//
{
  int order;
...
//
    ...
    {
      cout << "\n";
      cout << "NCC_TETRAHEDRON_RULE - Fatal error!\n;";
...
//  Parameters:
//
//    Output, int NCC_TETRAHEDRON_RULE_NUM, the number of rules available.
//
{
  int rule_num;
...
//
//    Output, int NCC_TETRAHEDRON_SUBORDER[SUBORDER_NUM], 
...
//
{
  ...
  {
    cout << "\n";
    cout << "NCC_TETRAHEDRON_SUBORDER - Fatal error!\n";
    cout << "  Illegal RULE = " << rule << "\n";
    exit ( 1 );
  }
...
//    Input, int RULE, the index of the rule.
//
//    Output, int NCC_TETRAHEDRON_SUBORDER_NUM, the number of suborders 
//    of the rule.
//
{
  int suborder_num;
  ...
  else
  {
    suborder_num = -1;
    cout << "\n";
    cout << "NCC_TETRAHEDRON_SUBORDER_NUM - Fatal error!\n";
    cout << "  Illegal RULE = " << rule << "\n";
    exit ( 1 );
  }
...
//
{
  ...
  if ( rule == 1 )
  {
    ncc_tetrahedron_subrule_01 ( suborder_num, suborder_xyz_n, &suborder_xyz_d,
    suborder_w_n, &suborder_w_d );
  }
  else if ( rule == 2 )
  {
    ncc_tetrahedron_subrule_02 ( suborder_num, suborder_xyz_n, &suborder_xyz_d,
    suborder_w_n, &suborder_w_d );
  }
  else if ( rule == 3 )
  {
    ncc_tetrahedron_subrule_03 ( suborder_num, suborder_xyz_n, &suborder_xyz_d,
    suborder_w_n, &suborder_w_d );
  }
  else if ( rule == 4 )
  {
    ncc_tetrahedron_subrule_04 ( suborder_num, suborder_xyz_n, &suborder_xyz_d,
    suborder_w_n, &suborder_w_d );
  }
  else if ( rule == 5 )
  {
    ncc_tetrahedron_subrule_05 ( suborder_num, suborder_xyz_n, &suborder_xyz_d,
    suborder_w_n, &suborder_w_d );
  }
  else if ( rule == 6 )
  {
    ncc_tetrahedron_subrule_06 ( suborder_num, suborder_xyz_n, &suborder_xyz_d,
    suborder_w_n, &suborder_w_d );
  }
  else if ( rule == 7 )
  {
    ncc_tetrahedron_subrule_07 ( suborder_num, suborder_xyz_n, &suborder_xyz_d,
    suborder_w_n, &suborder_w_d );
  }
  else
  {
    cout << "\n";
    cout << "NCC_TETRAHEDRON_SUBRULE - Fatal error!\n";
    cout << "  Illegal RULE = " << rule << "\n";
    exit ( 1 );
  }
...
//  Purpose:
//
//    NCC_TETRAHEDRON_SUBRULE_01 returns a compressed NCC rule 1.
//
//  Licensing:
//
//    This code is distributed under the GNU LGPL license. 
...
//  Purpose:
//
//    NCC_TETRAHEDRON_SUBRULE_02 returns a compressed NCC rule 2.
//
//  Licensing:
//
//    This code is distributed under the GNU LGPL license. 
...
//  Purpose:
//
//    NCC_TETRAHEDRON_SUBRULE_03 returns a compressed NCC rule 3.
//
//  Licensing:
//
//    This code is distributed under the GNU LGPL license. 
...
//  Purpose:
//
//    NCC_TETRAHEDRON_SUBRULE_04 returns a compressed NCC rule 4.
//
//  Licensing:
//
//    This code is distributed under the GNU LGPL license. 
...
//  Purpose:
//
//    NCC_TETRAHEDRON_SUBRULE_05 returns a compressed NCC rule 5.
//
//  Licensing:
//
//    This code is distributed under the GNU LGPL license. 
...
//  Purpose:
//
//    NCC_TETRAHEDRON_SUBRULE_06 returns a compressed NCC rule 6.
//
//  Licensing:
//
//    This code is distributed under the GNU LGPL license. 
...
//  Purpose:
//
//    NCC_TETRAHEDRON_SUBRULE_07 returns a compressed NCC rule 7.
//
//  Licensing:
//
//    This code is distributed under the GNU LGPL license. 
