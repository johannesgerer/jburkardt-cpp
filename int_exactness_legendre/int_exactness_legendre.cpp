...
double monomial_quadrature_legendre ( int expon, int order, double w[], double x[] );
...
//
{
  ...
  timestamp ( );
  cout << "\n";
  cout << "INT_EXACTNESS_LEGENDRE\n";
  cout << "  C++ version\n";
  cout << "\n";
  cout << "  Compiled on " << __DATE__ << " at " << __TIME__ << ".\n";
  cout << "\n";
  cout << "  Investigate the polynomial exactness of a Gauss-Legendre\n";
...
//
  cout << "\n";
  cout << "INT_EXACTNESS_LEGENDRE: User input:\n";
...
//
  ...
  {
    cout << "\n";
    cout << "INT_EXACTNESS_LEGENDRE - Fatal error!\n";
...
//
  cout << "\n";
  cout << "  A Gauss-Legendre rule would be able to exactly\n";
  cout << "  integrate monomials up to and including degree = " <<
   2 * order - 1 << "\n";
  cout << "\n";
  cout << "          Error                      Error           Degree\n";
  cout << "         (This rule)                (Trapezoid)\n";
  cout << "\n";
  ...
  for ( degree = 0; degree <= degree_max; degree++ )
  {
    ...
    cout << "  " << setw(24) << setprecision(16) << quad_error
               << "  " << setw(24) << setprecision(16) << quad_error2
               << "  " << setw(2) << degree << "\n";
  }
...
double monomial_quadrature_legendre ( int expon, int order, double w[], 
  double x[] )
...
//
//    Output, double MONOMIAL_QUADRATURE_LEGENDRE, the quadrature error.
//
{
  double exact;
  int i;
