...
//
{
  ...
  else
  {
    degree = -1;
    cout << "\n";
    cout << "TETRAHEDRON_NCC_DEGREE - Fatal error!\n";
...
//
    ...
    {
      cout << "\n";
      cout << "TETRAHEDRON_NCC_RULE - Fatal error!\n;";
...
//
{
  ...
  {
    cout << "\n";
    cout << "TETRAHEDRON_NCC_SUBORDER - Fatal error!\n";
    cout << "  Illegal RULE = " << rule << "\n";
    exit ( 1 );
  }
...
//
{
  ...
  else
  {
    suborder_num = -1;
    cout << "\n";
    cout << "TETRAHEDRON_NCC_SUBORDER_NUM - Fatal error!\n";
    cout << "  Illegal RULE = " << rule << "\n";
    exit ( 1 );
  }
...
//
{
  ...
  {
    cout << "\n";
    cout << "TETRAHEDRON_NCC_SUBRULE - Fatal error!\n";
    cout << "  Illegal RULE = " << rule << "\n";
    exit ( 1 );
  }
