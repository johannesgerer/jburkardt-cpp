...
//  Purpose:
//
//    MAIN is the main program for NCC_TRIANGLE_PRB.
//
//  Discussion:
//
//    NCC_TRIANGLE_PRB calls the NCC_TRIANGLE test routines.
//
//  Licensing:
//
...
//
{
  ...
  cout << "\n";
  cout << "NCC_TRIANGLE_PRB:\n";
  cout << "  C++ version\n";
  cout << "  Test the NCC_TRIANGLE library.\n";
...
//
{
  ...
  cout << "\n";
  cout << "TEST01\n";
  cout << "  NCC_TRIANGLE_RULE_NUM returns the number of rules;\n";
  cout << "  NCC_TRIANGLE_DEGREE returns the degree of a rule;\n";
  cout << "  NCC_TRIANGLE_ORDER_NUM returns the order of a rule.\n";
...
//
{
  ...
  cout << "\n";
  cout << "TEST02\n";
  cout << "  NCC_TRIANGLE_RULE returns the points and weights\n";
  ...
  for ( rule = 1; rule <= rule_num; rule++ )
  {
    ...
    ncc_triangle_rule ( rule, order_num, xytab, wtab );
...
//
{
  ...
  cout << "\n";
  cout << "TEST04\n";
  cout << "  NCC_TRIANGLE_RULE returns the points and weights of\n";
...
# define NODE_NUM 3
  ...
  cout << "  set of NCC points.\n";
  cout << "\n";

  strcpy ( file_name, "ncc_triangle_rule_00.eps" );
...
# define NODE_NUM 3
  ...
  ncc_triangle_rule ( rule, order_num, xy, w );
//
