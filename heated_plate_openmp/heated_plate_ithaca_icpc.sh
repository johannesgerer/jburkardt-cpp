...
#
icpc -openmp -parallel heated_plate_openmp.cpp
#
...
./heated_plate > heated_plate_ithaca_icpc_output.txt
#
...
rm heated_plate
#
echo "Program output written to heated_plate_ithaca_icpc_output.txt."
