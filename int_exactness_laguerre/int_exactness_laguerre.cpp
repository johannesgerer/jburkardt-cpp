...
double monomial_quadrature_laguerre ( int expon, int order, int option,
  double w[], double x[] );
...
//
  cout << "\n";
  cout << "INT_EXACTNESS_LAGUERRE: User input:\n";
...
//
  ...
  {
    cout << "\n";
    cout << "INT_EXACTNESS_LAGUERRE - Fatal error!\n";
...
//
  ...
  {
    quad_error = monomial_quadrature_laguerre ( degree, order, 
    option, w, x );
...
//
//    Output, double MONOMIAL_QUADRATURE_LAGUERRE, the quadrature error.
//
{
  double exact;
  int i;
