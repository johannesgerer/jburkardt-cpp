...
void tet_mesh_base_zero ( int node_num, int element_order, int element_num, 
  int element_node[] );
void tet_mesh_order4_refine_compute ( int node_num1, int element_num1, 
  double node_xyz1[], int element_node1[], int node_num2, int element_num2,
   int edge_data[], double node_xyz2[], int element_node2[] );
void tet_mesh_order4_refine_size ( int node_num1, int element_num1, 
  int element_node1[], int *node_num2, int *element_num2, int edge_data[] );
void timestamp ( );
...
//
  i4mat_header_read ( input_element_filename, &element_order, &element_num1 );
  ...
  element_node1 = i4mat_data_read ( input_element_filename, element_order, 
    element_num1 );

  cout << "\n";
  cout << "  Read the data in \"" << input_element_filename << "\".\n";

  i4mat_transpose_print_some ( element_order, element_num1, 
    element_node1, 1, 1, element_order, 5, "  First 5 input tetrahedrons:" );
//
//  Check for 1-based node-indexing, and convert it to 0-based.
//
  tet_mesh_base_zero ( node_num1, element_order, element_num1, element_node1 );
//
...
//
  if ( element_order == 4 )
  {
    ...
    tet_mesh_order4_refine_size ( node_num1, element_num1, element_node1, 
      &node_num2, &element_num2, edge_data ); 

    cout << "  Number of refined nodes =  " << node_num2 << "\n";
    ...
    tet_mesh_order4_refine_compute ( node_num1, element_num1, node_xyz1,
      element_node1, node_num2, element_num2, edge_data, node_xyz2, element_node2 ); 
  }
  else if ( element_order == 10 )
  {
  }
...
//
  ...
  i4mat_transpose_print_some ( element_order, element_num2, element_node2, 
...
//
  ...
  i4mat_write ( output_element_filename, element_order, element_num2, element_node2 );
...
//  next to each other.
//
  i4col_sort_a ( 5, 6*element_num1, edge_data );
//
