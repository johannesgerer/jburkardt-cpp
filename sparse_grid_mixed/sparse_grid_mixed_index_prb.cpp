...
void sparse_grid_mixed_index_tests ( double tol );
...
//  Discussion:
//
//    SPARSE_GRID_MIXED_INDEX_PRB tests the SPARSE_GRID_MIXED_INDEX routines.
//
//  Licensing:
//
...
//
{
  ...
  webbur::timestamp ( );
  std::cout << "\n";
  std::cout << "SPARSE_GRID_MIXED_INDEX_PRB\n";
  std::cout << "  C++ version\n";

  tol = sqrt ( webbur::r8_epsilon ( ) );
  sparse_grid_mixed_index_tests ( tol );
//
//  Terminate.
//
  std::cout << "\n";
...
//
{
  ...
  std::cout << "\n";
  std::cout << "SPARSE_GRID_MIXED_INDEX_TESTS\n";
  std::cout << "  Call SPARSE_GRID_MIXED_INDEX_TEST with various arguments.\n";
...
//
{
  ...
  std::cout << "\n";
  std::cout << "SPARSE_GRID_MIXED_INDEX_TEST\n";
  std::cout << "  SPARSE_GRID_MIXED_INDEX returns index and order vectors that\n";
  std::cout << "  identify each point in a multidimensional sparse grid with mixed factors.\n";
  std::cout << "\n";
  ...
  for ( dim = 0; dim < dim_num; dim++ )
  {
    ...
    {
      std::cout << "\n";
      std::cout << "SPARSE_GRID_MIXED_INDEX_TEST - Fatal error!\n";
