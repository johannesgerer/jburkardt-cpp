...
int triangulation_hits ( int node_num, double node_xy[], int triangle_order, 
...
//
{
  ...
  cout << "\n";
  cout << "TRIANGULATION_HISTOGRAM:\n";
  cout << "  C++ version:\n";
  cout << "  Compute a histogram for datapoints in a triangulation.\n";
  cout << "\n";
...
//
  ...
  cout << "\n";
  cout << "  Triangle order ELEMENT_ORDER = " << element_order << "\n";
  cout << "  Number of triangles ELEMENT_NUM  = " << element_num << "\n";
...
//
  ...
  cout << "\n";
  cout << "  Spatial dimension DIM_NUM = " << dim_num << "\n";
  cout << "  Number of data points DATA_NUM  = " << data_num << "\n";
...
//
  ...
  triangulation_area =  triangulation_areas ( node_num, node_xy, element_order,
...
//
  ...
  triangulation_hit = triangulation_hits ( node_num, node_xy, element_order,
...
//
  cout << "\n";
  cout << "TRIANGULATION_HISTOGRAM:\n";
  cout << "  Histogram report:\n";
  cout << "\n";
  cout << "  Node data from         \"" << node_filename    << "\".\n";
  cout << "  Element data from      \"" << element_filename << "\".\n";
  cout << "  Sample point data from \"" << data_filename    << "\".\n";
  cout << "  Number of sample points = " << data_num << "\n";
  cout << "\n";
  cout << "  Triangle        Area          Hits  Area Ratio       Hit Ratio\n";
  cout << "\n";
  for ( element = 0; element < element_num; element++ )
  {
    cout << "  " << setw(8)  << element
         << "  " << setw(14) << element_area[element]
         << "  " << setw(8)  << element_hit[element]
         << "  " << setw(14) << element_area[element] / triangulation_area
         << "  " << setw(14) << ( double ) ( element_hit[element] ) 
                              / ( double ) ( triangulation_hit ) << "\n";
  }
  cout << "\n";
  cout << "  " << "   Total"
       << "  " << setw(14) << triangulation_area
       << "  " << setw(8)  << triangulation_hit
       << "  " << setw(14) << 1.0
       << "  " << setw(14) << 1.0 << "\n";
//
//  Terminate.
...
//
{
  ...
  for ( triangle = 0; triangle < triangle_num; triangle++ )
  {
    for ( j = 0; j < 3; j++ )
    {
      ...
      triangle_xy[0+j*2] = node_xy[0+nj*2];
      triangle_xy[1+j*2] = node_xy[1+nj*2];
    }
