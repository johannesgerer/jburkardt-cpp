...
int main ( );
void sgmga_aniso_balance_tests ( );
void sgmga_aniso_balance_test ( double alpha_max, int dim_num, double level_weight[] );
void sgmga_aniso_normalize_tests ( );
void sgmga_aniso_normalize_test ( int dim_num, double level_weight[] );
void sgmga_importance_to_aniso_tests ( );
...
//
{
  ...
  std::cout << "\n";
  std::cout << "SGMGA_ANISO_NORMALIZE_PRB:\n";
  std::cout << "  C++ version\n";
  std::cout << "  Test the SGMGA_ANISO_NORMALIZE and\n";
  std::cout << "  SGMGA_IMPORTANCE_TO_ANISO functions.\n";
...
//
{
  ...
  std::cout << "\n";
  std::cout << "SGMGA_ANISO_BALANCE_TESTS\n";
  std::cout << "  Call SGMGA_ANISO_BALANCE_TEST with various arguments.\n";
...
void sgmga_aniso_balance_test ( double alpha_max, int dim_num, 
  double level_weight[] )
...
//
{
  ...
  std::cout << "\n";
  std::cout << "SGMGA_ANISO_BALANCE_TEST\n";
  ...
  level_weight2 = webbur::sgmga_aniso_balance ( alpha_max, dim_num, level_weight );
...
//
{
  ...
  std::cout << "\n";
  std::cout << "SGMGA_ANISO_NORMALIZE_TESTS\n";
  std::cout << "  Call SGMGA_ANISO_NORMALIZE_TEST with various arguments.\n";
...
//
{
  ...
  std::cout << "\n";
  std::cout << "SGMGA_ANISO_NORMALIZE_TEST\n";
  std::cout << "  Input weight sum: "
    << webbur::r8vec_sum ( dim_num, level_weight ) << "\n";
  for ( dim = 0; dim < dim_num; dim++ )
  {
  ...
  {
    webbur::sgmga_aniso_normalize ( option, dim_num, level_weight );
...
//
{
  ...
  std::cout << "\n";
  std::cout << "SGMGA_IMPORTANCE_TO_ANISO_TESTS\n";
  std::cout << "  Call SGMGA_IMPORTANCE_TO_ANISO_TEST with various arguments.\n";
...
//
{
  ...
  std::cout << "\n";
  std::cout << "SGMGA_IMPORTANCE_TO_ANISO_TEST\n";
