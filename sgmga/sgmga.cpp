...
//
  for ( ; ; )
  {
    webbur::sgmga_vcn_ordered ( dim_num, level_weight, level_1d_max, 
...
//
    level_growth_to_order ( dim_num, level_1d, rule, growth, order_1d );
//
...
//
  ...
  for ( dim = 0; dim < dim_num; dim++ )
  {
    ...
    {
      level_growth_to_order ( 1, &level, rule+dim, growth+dim, &order );
...
//
  point_total_num = webbur::sgmga_size_total ( dim_num, level_weight, level_max,
    rule, growth );
//
...
//  Compute the combinatorial coefficient.
//
    coef = webbur::sgmga_vcn_coef ( dim_num, level_weight, level_1d, q_max );
...
void sgmga_vcn ( int n, double w[], int x[], double q_min, double q_max, 
  bool *more )
...
double sgmga_vcn_coef ( int dim_num, double level_weight[], int x[], 
  double q_max )
...
double sgmga_vcn_coef_naive ( int dim_num, double level_weight[], int x_max[],
...
void sgmga_vcn_naive ( int dim_num, double level_weight[], int x_max[], int x[], 
...
//
  for ( ; ; )
  {
    webbur::sgmga_vcn ( dim_num, level_weight, x, q_min2, q_max2, more );
//
...
//
  for ( ; ; )
  {
    webbur::sgmga_vcn_naive ( dim_num, level_weight, x_max, x, q_min2, q_max2, 
      more );
//
//  If another solution was found, return it.
//
