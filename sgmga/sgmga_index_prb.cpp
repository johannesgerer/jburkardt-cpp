...
void sgmga_index_tests ( );
void sgmga_index_test ( int dim_num, double importance[], double level_weight[], 
  int level_max_min, int level_max_max, int rule[], int growth[],
  int np[], double p[], 
...
//
{
  ...
  webbur::timestamp ( );
  std::cout << "\n";
  std::cout << "SGMGA_INDEX_PRB\n";
  std::cout << "  C++ version\n";
  std::cout << "  Test the SGMGA_INDEX function.\n";
...
//
{
  ...
  std::cout << "\n";
  std::cout << "SGMGA_INDEX_TESTS\n";
  std::cout << "  Call SGMGA_INDEX_TEST with various arguments.\n";
//
...
//
{
  ...
  std::cout << "\n";
  std::cout << "SGMGA_INDEX_TEST\n";
  std::cout << "  SGMGA_INDEX returns index and order vectors that\n";
  ...
  for ( dim = 0; dim < dim_num; dim++ )
  {
    ...
    {
      std::cerr << "\n";
      std::cerr << "SGMGA_INDEX_TEST - Fatal error!\n";
