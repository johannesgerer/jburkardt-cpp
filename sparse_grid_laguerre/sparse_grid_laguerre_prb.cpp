...
//
{
  ...
  cout << "  C++ version\n";
  cout << "  Test the SPARSE_GRID_LAGUERRE library.\n";
//
...
//
{
  ...
  cout << "\n";
  cout << "TEST01\n";
  cout << "  SPARSE_GRID_LAGUERRE_SIZE returns the number of distinct\n";
  cout << "  points in a Gauss-Laguerre sparse grid.\n";
  cout << "\n";
  cout << "  Note that, unlike most sparse grids, a sparse grid based on\n";
  cout << "  Gauss-Laguerre points is NOT nested.\n";
  cout << "\n";
...
//
{
  ...
  cout << "\n";
  cout << "TEST02:\n";
  cout << "  SPARSE_GRID_LAGUERRE_INDEX returns abstract indices for the\n";
  cout << "  points that make up a Gauss-Laguerre sparse grid.\n";
...
//
  ...
  sparse_grid_laguerre_index ( dim_num, level_max, point_num, grid_index, 
    grid_base );
//
...
//
{
  ...
  cout << "\n";
  cout << "TEST03:\n";
  cout << "  SPARSE_GRID_LAGUERRE makes a sparse Gauss-Laguerre grid.\n";
...
//
  sparse_grid_laguerre ( dim_num, level_max, point_num, grid_weight, 
    grid_point );
//
//  Print them out.
//
...
//
{
  ...
  cout << "\n";
  cout << "TEST04:\n";
  cout << "  Compute the weights of a Gauss-Laguerre sparse grid .\n";
  cout << "\n";
  cout << "  As a simple test, sum these weights.\n";
  cout << "  They should sum to exactly 1.\n";
...
//
{
  ...
  cout << "\n";
  cout << "TEST05\n";
  cout << "  Check the exactness of a Gauss-Laguerre sparse\n";
...
//
{
  ...
  cout << "\n";
  cout << "TEST06:\n";
  cout << "  Call SPARSE_GRID_LAGUERRE to make a sparse Gauss-Laguerre grid.\n";
...
//  Write the data out.
//
  r_filename = "lg_d" + i4_to_string ( dim_num, "%d" )
    + "_level" + i4_to_string ( level_max, "%d" ) + "_r.txt";
  w_filename = "lg_d" + i4_to_string ( dim_num, "%d" )
    + "_level" + i4_to_string ( level_max, "%d" ) + "_w.txt";
  x_filename = "lg_d" + i4_to_string ( dim_num, "%d" )
