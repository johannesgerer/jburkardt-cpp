...
//
{
  ...
  for ( i = 0; i < 3; i++ )
  {
    ...
    {
      cerr << "\n";
      cerr << "CUBE_MONOMIAL - Fatal error!\n";
...
//
{
  ...
  cout << "\n";
  cout << "CUBE_MONOMIAL_TEST\n";
  cout << "  For the unit hexahedron,\n";
  cout << "  CUBE_MONOMIAL returns the exact value of the\n";
  cout << "  integral of X^ALPHA Y^BETA Z^GAMMA\n";
  cout << "\n";
  cout << "  Volume = " << cube_volume ( a, b ) << "\n";
  cout << "\n";
...
# define DIM_NUM 3
  ...
  cout << "  CUBE_RULE, which returns N1 by N2 by N3 point rules..\n";
