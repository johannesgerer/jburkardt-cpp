...
//  Usage:
//
//    polygonal_surface_display_open_gl prefix
//
...
//
{
  ...
  cout << "\n";
  cout << "POLYGONAL_SURFACE_DISPLAY_OPENGL:\n";
  cout << "  C++ version:\n";
  cout << "\n";
  cout << "  Compiled on " << __DATE__ << " at " << __TIME__ << ".\n";
  cout << "\n";
  cout << "  This program reads files defining the nodes and elements\n";
  cout << "  of a polygonal mesh that forms a surface in 3D. \n";
  cout << "\n";
...
//
  ...
  {
    cout << "\n";
    cout << "POLYGONAL_SURFACE_DISPLAY_OPENGL - Fatal error!\n";
...
//
  ...
  cout << "\n";
  cout << "  The polygon order =  " << element_order << "\n";
  ...
  if ( element_order < 3 )
  {
    cout << "\n";
    cout << "POLYGONAL_SURFACE_DISPLAY_OPENGL - Fatal error!\n";
    cout << "  The polygonal order must be at least 3!\n";
    exit ( 1 );
  }
...
//
  ...
  glutCreateWindow ( "Rotating Polygonal Surface" );
...
//    We then consider each face of the polygonal surface.  We take every
