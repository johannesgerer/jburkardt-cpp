...
//
{
  ...
  cout << "LISSAJOUS:\n";
  cout << "  C++ version:\n";
  cout << "  Use DISLIN routines to plot (X,Y) data as a plane curve.\n";
//
//  Read the data.
//
...
//  'USA' is 2790 plot units wide and 2169 plot units high.
...
//
  color ( "blue" );
//
//  At every 10th data point, draw a circle of radius 0.01.
//
  r = 0.02;
  for ( i = 0; i < n; i = i + 10 )
  {
