...
//
//    Input, int NODE_BOUNDARY[NODE_NUM], is TRUE if the node is
...
//  Discussion:
//
//    We intend for the Dirichlet boundary conditions to be applied
//    on the inflow and horizontal walls, but not the outflow.
//
//    However, as a beginning, we will also specify the outflow.
//
//                           no slip wall
//
//                       1 +---------------+
//                          
//    Parabolic inflow -->                 --->  Parabolic outflow
//                          
//                       0 +---------------+
//
//                         0               3
