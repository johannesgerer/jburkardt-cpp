...
void test02 ( );
//
//  Interfaces to FORTRAN90 routines.
...
//  of the subroutines as recorded in the C++ and FORTRAN90 compiled codes.
//
extern "C" {
...
{
//
//  To call the F90 version of TIMESTAMP, we append an underscore to its name.
//
  timestamp_ ( );

  cout << "\n";
  cout << "KRONROD_PRB:\n";
  cout << "  Combination C++ and FORTRAN90 version.\n";
  cout << "  Demonstrate how a C++ main program can call\n";
  cout << "  a FORTRAN90 library.\n";
...
//
{
  ...
  x = new double[n+1];
//
//  To call the FORTRAN90 subroutine KRONROD, we must append
