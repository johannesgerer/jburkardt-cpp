...
//
{
  ...
  cout << "\n";
  cout << "TRIANGULATION_T3_TO_T4\n";
  cout << "  C++ version:\n";
  cout << "  Read a 3-node T3 triangulation and\n";
  cout << "  write out a 4-node T4 triangulation.\n";
  cout << "\n";
  cout << "  Read a dataset of NODE_NUM_T3 points in 2 dimensions.\n";
  cout << "  Read an associated triangulation dataset of ELEMENT_NUM \n";
  cout << "  triangles which uses 3 nodes per triangle.\n";
  cout << "\n";
  cout << "  Create new nodes which are triangle centroids,\n";
  cout << "  generate new node and triangulation data for\n";
  cout << "  4-node elements, and write them out.\n";
  cout << "\n";
...
//  Read the node data.
//
  r8mat_header_read ( node_t3_filename, &dim_num, &node_num_t3 );

  cout << "\n";
  cout << "  Read the header of \"" << node_t3_filename << "\".\n";
  cout << "\n";
  cout << "  Spatial dimension DIM_NUM = " << dim_num << "\n";
  cout << "  Number of nodes NODE_NUM_T3  = " << node_num_t3 << "\n";

  node_xy_t3 = r8mat_data_read ( node_t3_filename, dim_num, node_num_t3 );

  cout << "\n";
  cout << "  Read the data in \"" << node_t3_filename << "\".\n";

  r8mat_transpose_print_some ( dim_num, node_num_t3, node_xy_t3, 1, 1, 
    dim_num, 5, "  Portion of coordinate data from file:" );
//
//  Read the element data.
//
  i4mat_header_read ( element_t3_filename, &element_order_t3, &element_num );

  if ( element_order_t3 != 3 )
  {
    cout << "\n";
    cout << "TRIANGULATION_T3_TO_T4 - Fatal error!\n";
    cout << "  Data is not for a 3-node triangulation.\n";
    exit ( 1 );
  }

  cout << "\n";
  cout << "  Read the header of \"" << element_t3_filename << "\".\n";
  cout << "\n";
  cout << "  Triangle order ELEMENT_ORDER_T3 = " << element_order_t3 << "\n";
  cout << "  Number of elements ELEMENT_NUM  = " << element_num << "\n";

  element_node_t3 = i4mat_data_read ( element_t3_filename, element_order_t3,
    element_num );

  cout << "\n";
  cout << "  Read the data in \"" << element_t3_filename << "\".\n";
...
//
  mesh_base_zero ( node_num_t3, element_order_t3, element_num, element_node_t3 );
//
//  Allocate space.
//
...
//
  ...
  cout << "\n";
  cout << "  Wrote the T4 node data to \"" << node_t4_filename << "\".\n";

  i4mat_write ( element_t4_filename, element_order_t4, element_num, 
    element_node_t4 );

  cout << "  Wrote the T4 element data to \"" << element_t4_filename << "\".\n";
//
//  Free up memory.
//
  delete [] element_node_t3;
  delete [] element_node_t4;
  delete [] node_xy_t3;
  delete [] node_xy_t4;
