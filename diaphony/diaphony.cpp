...
//
{
  ...
  if ( verbose )
  {
    ...
    cout << "DIAPHONY:\n";
    cout << "  C++ version\n";
    cout << "  Compute the diaphony of a point set.\n";
  }
//
...
//
  ...
  {
    cout << "\n";
    cout << "DIAPHONY - Fatal error!\n";
    cout << "  At least one coordinate of a point is less than 0.\n";
    exit ( 1 );
  }
  else if ( 1.0 < r8mat_max ( dim_num, point_num, points ) )
  {
    cout << "\n";
    cout << "DIAPHONY - Fatal error!\n";
    cout << "  At least one coordinate of a point is greater than 1.\n";
    exit ( 1 );
  }
//
//  Analyze the data.
//
  ...
  cout << "\n";
  cout << "  File  M  N  Diaphony  1/sqrt(N)  D/sqrt(N)\n";
  cout << "  " << input_filename
       << "  " << setw(2) << dim_num
       << "  " << setw(5) << point_num
       << "  " << setw(14) << d
