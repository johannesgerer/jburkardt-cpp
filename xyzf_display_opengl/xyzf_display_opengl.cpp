...
//  Discussion:
//
//    This program reads XYZL information defining 3D points and faces,
...
//
//  If the XYZF data was created using 1-based indexing, we need to correct that,
//  if possible.
//
